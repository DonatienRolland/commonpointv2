...
// function switchPublicPrive(){
//   const option = document.getElementById('evenement_type_of_evenement')
//   const users = document.querySelectorAll('.userToAdd')
//   const input = document.getElementById('participantsToCreate')
//   setPriveAndPublic(option, users, input)
...
// // quand on selectionne publique, tout les user_ids sont dans l'input
// // quand on selectionne prive rien ou ceux qui était enregristré
